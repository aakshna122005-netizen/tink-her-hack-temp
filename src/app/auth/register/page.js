        ...
        <>
            ...
            <div style={{ minHeight: 'calc(100vh - 64px)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
                <div className="glass-card animate-fade-in" style={{ padding: 40, width: '100%', maxWidth: 440 }}>
                    ...
                    <p style={{ color: '#94A3B8', marginBottom: 32, fontSize: 14 }}>Join the startup networking revolution</p>
                    ...
                    <form onSubmit={handleSubmit}>
                        <div style={{ marginBottom: 16 }}>
                            <label style={{ display: 'block', fontSize: 13, fontWeight: 500, marginBottom: 6, color: '#94A3B8' }}>Full Name</label>
                    ...
                    <p style={{ textAlign: 'center', marginTop: 24, fontSize: 14, color: '#94A3B8' }}>
                        Already have an account? <Link href="/auth/login" style={{ color: '#3B82F6', fontWeight: 600, textDecoration: 'none' }}>Sign In</Link>
                    </p>
                </div>
            </div>
        </>
